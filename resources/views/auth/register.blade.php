...
<form method="POST" style="width: 100%;" action="{{ route('register') }}">
                            @csrf
    ...
    <div class="mb-3" style="width: 100%;margin-bottom: 10px;">
        <input style="width: 100%;" type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Nome e Sobrenome" name="name" id="name">
    </div>
