    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>{{ isset($role) ? 'Edit' : 'Create'}} Nível<div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                   name="name" value="{{ $role->name ?? old('name') }}" required autocomplete="name"
                                   autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <input id="name_bn" type="text" class="form-control @error('name_bn') is-invalid @enderror"
                                   name="name_bn" value="{{ $role->name_bn ?? old('name_bn') }}" required
