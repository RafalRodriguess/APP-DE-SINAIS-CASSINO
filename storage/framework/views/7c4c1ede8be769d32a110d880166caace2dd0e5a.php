        ...
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                ...
                <a href="<?php echo e(route('app.users.create')); ?>" class="btn-shadow mr-3 btn btn-primary" name="button">
                    <i class="fas fa-plus-circle"></i>&nbsp;Adiciionar Usuarios
                </a>
                <?php endif; ?>
            </div>
        </div>
...
<?php echo $__env->make('layouts.backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u859157959/domains/squadgaming.online/public_html/resources/views/backend/users/index.blade.php ENDPATH**/ ?>