    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div><?php echo e(isset($role) ? 'Edit' : 'Create'); ?> Nível<div>
            </div>
        ...
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                <form action="<?php echo e(isset($role) ? route('app.roles.update', $role->id) : route('app.roles.store')); ?>"
                    ...
                    <?php endif; ?>
                    <div class="card-body">
                        <h5 class="card-title">Manage Nível</h5>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="text-center">
                            <strong>Manage Permission For Nível<strong>
...
<?php echo $__env->make('layouts.backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u859157959/domains/squadgaming.online/public_html/resources/views/backend/roles/form.blade.php ENDPATH**/ ?>