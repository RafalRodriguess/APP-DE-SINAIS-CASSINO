        ...
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu">
                ...
                <li class="app-sidebar__heading">
                    ...
                    <ul>
                        <li class="<?php echo e(Request::is('app/videos*') ? 'mm-active' : ''); ?>">
                            <a href="<?php echo e(route('app.videos.index')); ?>" class="">
                                <i class="metismenu-icon pe-7s-cloud"></i>Videos
                            </a>
                        </li>
...
<?php /**PATH C:\xampp\htdocs\s\resources\views/backend/partials/sidebar.blade.php ENDPATH**/ ?>